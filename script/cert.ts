...
export async function generateBoundCertificate() {
	// 1) Create or load your node's secp256k1 identity
	const nodePriv = generateSecp256k1PrivateKey();
	const nodePubCompressed = computeSecp256k1PublicKey(nodePriv);
